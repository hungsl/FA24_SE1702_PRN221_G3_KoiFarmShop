...
namespace KoiFarmShop.Service.Implement.Service
{
    public class AppointmentService : IAppointmentService
    {
        ...
        {
            // Additional business logic could go here if needed, e.g., checking access permissions, logging, etc.

            // Call repository method to fetch filtered appointments
            var appointments = await _unitOfWork.AppointmentRepository.SearchAppointmentsAsync(customerName, petName, appointmentDate);

            // Post-processing on appointments (if needed)
            // For example, you could map to DTOs here or apply additional filtering based on complex conditions
